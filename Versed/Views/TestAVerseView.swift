            ...
            Section() {
                ...
                HStack {
                    Picker("Sense", selection: $selectedSense) {
                        Image(systemName: AppConstant.SFSymbol.hear).tag(Sense.hear)
                        Image(systemName: AppConstant.SFSymbol.see).tag(Sense.see)
                    }
                    ...
                    Button() {
                        ...
                        Image(systemName: AppConstant.SFSymbol.cue)
                    }
                }
